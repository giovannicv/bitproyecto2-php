...
<!-- header -->
			<header>
					...
					<nav>
						<ul id="menu">
							<li><a href="INICIO.php">INICIO</a>
								<ul id="menu">
									<li><a href="horario_salida.php">HORARIO DE SALIDA</a></li>
								</ul>
							</li>
				...
				<div id="slogan">
					"HORARIO<span>DE SALIDA"</span>
				</div>
				<div id="content">
					<form action="horario_salida.php" method="POST">
						<label>ID:</label>
...
<?php
	...
	if(@$_POST['BtnENVIAR']){
	$var1=$_POST["ID"];
	echo '<div id="slideDiv">'.'<h1>El HORARIO SALIDA FUE REGISTRADA</h1>'.'</div>';
	?>
	...
	<?php
	$query=OCIParse($conn, "begin salida_usuario(:dato1);end;");
