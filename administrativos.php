...
<!-- header -->
			<header>
				...
				<nav>
		<ul id="menu">
			<li class="end"><a href="administrativos.php">ADMINISTRATIVOS</a>
			<ul>
...
<!-- / header -->
		...
		<div class="body2">
		<h1>REGISTRO DE PLANTEL ADMINISTRATIVO</h1>
		<fieldset >
            <div id="formu">
            	<form action="administrativos.php" method="post" id="contacto">
	                <label>ID:</label>
	                <input type="text" name="id" placeholder="Ci" maxlength="10"></br>
					<label>Nombre:</label>
	                <input type="text" name="nombre" placeholder="Nombre"></br>
					<label>Apellido Paterno:<label>
	                <input type="text" name="apellidoPaterno" placeholder="ApellidosP"></br>
					<label>Apellido Materno:<label>
	                <input type="text" name="apellidoMaterno" placeholder="ApellidosM"></br>
	                <label>Sueldo:<label>
	                <input type="text" name="sueldo" placeholder="sueldo"></br>
	                <button id="slideupBtn" type="submit" name="BtnENVIAR" value="ENVIAR">Insertar</button>
            	</form>
            </div>
            </fieldset>
	</div>
...
<?php
	...
	$var5=$_POST["sueldo"];
	echo '<div id="slideDiv">'.'<h1>ADMINISTRATIVO REGISTRADO</h1>'.'</div>';
	?>
