...
<!-- header -->
			<header>
				...
				<nav>
		<ul id="menu">
			<li><a href="re_ad.php">REPORTE ADMINISTRATIVOS</a></li>
		</ul>
		</nav>
...
<div class="body2">
		...
		<fieldset >
            <div id="formu">
            	<form action="re_ad.php" method="post" id="contacto">
	                <label>ID:</label>
	                <input type="text" name="ci" placeholder="Ci" maxlength="10"></br>
	                <button id="slideupBtn" type="submit" name="BtnGuardar" value="Insertar">Insertar</button>
            	</form>
            </div>
            </fieldset>
	</div>
